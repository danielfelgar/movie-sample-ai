...
Define o conteúdo mínimo obrigatório do `AGENTS.md`, `README.md` e `CLAUDE.md` do `movie-sample-ai`, incluindo o catálogo de repositórios do workspace, o passo a passo de montagem e a fronteira entre documentação geral e específica de cada subprojeto.
