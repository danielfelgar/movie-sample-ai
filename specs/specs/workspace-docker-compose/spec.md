...
Define onde o `docker-compose.yml` do workspace é versionado e qual esqueleto de serviços ele deve declarar para orquestrar os componentes do `movie-sample-ai`.
